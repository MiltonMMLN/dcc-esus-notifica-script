...
pacotes <- c("dplyr", "readr", "stringr", "lubridate", "openxlsx",
             "stringdist", "stringi", "purrr", "readxl", "tools")
...
# ============================================================
# --- 3) Seleção de arquivos de entrada (CSV ou XLSX) ---
# ============================================================
message("Selecione o ARQUIVO DCC (.csv ou .xlsx)")
arq_dcc <- file.choose()
message("Selecione o ARQUIVO DCA (.csv ou .xlsx)")
arq_dca <- file.choose()
...
# ============================================================
# --- 5) Leitura padronizada Inteligente ---
# ============================================================
ler_arquivo_padrao <- function(caminho) {
  extensao <- tolower(tools::file_ext(caminho))
  
  if (extensao %in% c("xlsx", "xls")) {
    # Lê excel forçando tudo para texto, preservando zeros à esquerda
    readxl::read_excel(caminho, col_types = "text")
  } else {
    # Lê CSV forçando tudo para texto
    readr::read_delim(
      caminho,
      delim = ";",
...
dcc_raw <- ler_arquivo_padrao(arq_dcc)
dca_raw <- ler_arquivo_padrao(arq_dca)
...
parse_data_segura <- function(x) {
  # Tenta formatos BR, formatos ISO e números de série do Excel
...
# ============================================================
# --- 9) Seleção de colunas e renomeação ---
# ============================================================
base_dcc_sel <- dcc %>%
...
# ============================================================
# --- 11) Similaridade de nome e filtro por limiares ---
# ============================================================
